"""Data generation pipeline for the NC Stein FY2026-27 tax proposals dashboard.

Runs the nc_tax_calc microsimulation for tax years 2026, 2027, and 2028
against the North Carolina state dataset and saves output to
frontend/public/data/ as CSVs.
