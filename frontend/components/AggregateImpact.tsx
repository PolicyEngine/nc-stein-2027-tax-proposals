...
export default function AggregateImpact({ triggered }: Props) {
  // User-selectable year across the three covered years (2026, 2027, 2028);
  // defaults to 2027, the first year the rate-maintenance and standard-
    ...
    return (
      <div className="flex items-center justify-center py-20">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Loading North Carolina impact data...</p>
        </div>
      </div>
    );
  }
  ...
  if (error) {
    ...
    return (
      <div className="bg-gray-50 border border-gray-200 rounded-lg p-6">
        <h3 className="text-gray-800 font-semibold mb-2">North Carolina impact data not yet available</h3>
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-2xl font-bold text-primary">North Carolina impact analysis</h2>
      <p className="text-sm text-gray-600">
        Comparing the Stein FY2026-27 reform to expected current law (which
        reflects the triggered individual income tax rate cuts) for
        ...
        <div className="space-y-6">
          ...
          <div>
            <h3 className="text-lg font-semibold text-gray-800 mb-3">
              North Carolina state revenue change ({selectedYear})
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className={`rounded-lg p-5 border ${
                data.budget.state_tax_revenue_impact >= 0 ? 'bg-green-50 border-success' : 'bg-red-50 border-red-300'
              }`}>
                <p className="text-sm text-gray-700 mb-2">North Carolina state revenue change</p>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  Change in North Carolina state tax collections
                </p>
              </div>
              <div className={`rounded-lg p-5 border ${
              ...
              <div className={`rounded-lg p-5 border ${
                ...
                <p className="text-xs text-gray-500 mt-1">
                  Net gain to North Carolina households
                </p>
              </div>
            </div>
          </div>
