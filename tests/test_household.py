"""
Tests for the nc_tax_calc.household module.

These tests verify that the household-situation builder produces correct
PolicyEngine-compatible dictionaries, defaulting to North Carolina (NC)
for this dashboard.
"""

import pytest
from nc_tax_calc.household import build_household_situation
